...
Research Flow 0.8.3 installs a `research-flow` command. It runs a small Python server
...
"$HOME/.local/share/research-flow-env/bin/python" -m pip install \
  https://github.com/SpicyChicken6/research-flow/releases/download/v0.8.3/research_flow-0.8.3-py3-none-any.whl
